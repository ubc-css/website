        ...
        <footer className="site-footer">
            ...
            <div className="footer-bottom">
                ...
                <div className="footer-contact">
                    ...
                    <a
                        href="https://discord.gg/replace-with-real-invite"
                        target="_blank"
                        rel="noreferrer"
                        aria-label="UBC CSS on Discord"
                    >
                        {/* Placeholder invite link — swap for the club's real
                            Discord invite once one exists. Discord's actual logo
                            mark — exact path from Simple Icons (simple-icons/
                            simple-icons, icons/discord.svg) — same currentColor/
                            shared-circle-button treatment as Linktree above,
                            rather than white-on-blurple. */}
                        <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
